  ...
  return (
    <>
      ...
      <Flex direction="column" align="center" h="100vh">
        <Flex alignItems="center" justify="space-between" width="90%" mt={10}>
        ...
        <Flex direction="column" justify="center" align="center" mt={5}>
          <Text fontSize="lg" w="50vw" align="center">
            While we are working on a new platform designed for you, please use
            the options below to make payments and schedule appointments.
          </Text>
